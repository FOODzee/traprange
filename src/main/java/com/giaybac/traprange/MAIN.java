...
public class MAIN {
    ...
    private static void printHelp() {
        ...
        help.append("Argument list: \n")
                ...
                .append("\t-el: except lines. For example, to exept lines 1,2,3 and -1 (last line) in all pages and line 4 in page 8, the value shoud be: \"1,2,3,-1,4@7\" NOTE that pages are numbered starting from zero!\n")
                .append("\t-p: only parse these pages. Ex: 0,1,2,3\n")
                .append("\t-ep: all pages except these pages. Ex: 0,1,2\n")
